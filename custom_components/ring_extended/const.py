...
HEALTH_SENSORS: tuple[RingExtendedSensorDescription, ...] = (
    ...
    RingExtendedSensorDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        category="health",
        attr_path="health.average_signal_strength",
    ),
    RingExtendedSensorDescription(
        key="average_signal_category",
        translation_key="average_signal_category",
        category="health",
        attr_path="health.average_signal_category",
    ),
    RingExtendedSensorDescription(
        key="latest_signal_strength",
        translation_key="latest_signal_strength",
        native_unit_of_measurement=SIGNAL_STRENGTH_DECIBELS_MILLIWATT,
        device_class=SensorDeviceClass.SIGNAL_STRENGTH,
        state_class=SensorStateClass.MEASUREMENT,
        category="health",
        attr_path="health.latest_signal_strength",
    ),
    RingExtendedSensorDescription(
        key="latest_signal_category",
        translation_key="latest_signal_category",
        category="health",
        attr_path="health.latest_signal_category",
    ),
    RingExtendedSensorDescription(
        key="connected",
    ...
    RingExtendedSensorDescription(
        key="packet_loss_strength",
        translation_key="packet_loss_strength",
        state_class=SensorStateClass.MEASUREMENT,
        category="health",
        attr_path="health.packet_loss_strength",
    ),
    RingExtendedSensorDescription(
        key="bandwidth",
